...
Public Class F_ClienteNuevo
    ...
    Private Sub btnguardar_Click(sender As Object, e As EventArgs) Handles btnguardar.Click
        If (_prValidar()) Then
            ...
            Dim res As Boolean = L_fnGrabarCLiente("", "", tbRazonSocial.Text, tbNombre.Text, 1, 1, 1, "", "", "", "", 70, 1, 0, 0, "", Now.Date.ToString("yyyy/MM/dd"), tbRazonSocial.Text, 1, tbNit.Text, 0, 0, Now.Date.ToString("yyyy/MM/dd"), Now.Date.ToString("yyyy/MM/dd"), "Default.jpg", 1, TbEmailN.Text, TipoDoc)
            If res Then
